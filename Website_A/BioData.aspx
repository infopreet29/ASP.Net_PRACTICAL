...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <br />
        <br />
        <asp:LinkButton ID="LinkButton2" runat="server" PostBackUrl="~/Default.aspx">CLICK TO OPEN A PAGE</asp:LinkButton>
        <br />
        ------------------------------------------------------------------------------------------------------------
      </div>
      <div align="center">
        ...
        DATA
          ...
          <br />
          <br />
          <asp:Label ID="lblData" runat="server" Text="Label" Font-Size="Larger"></asp:Label>
          <br />
